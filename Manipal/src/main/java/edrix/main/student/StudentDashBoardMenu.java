...
import edrix.main.commons.DashboardEvent.PostViewChangeEvent;
...
public class StudentDashBoardMenu extends CustomComponent {
	...
	private Component buildToggleButton() {
	 ...
	 private Component buildMenuItems() {
	        ...
	        for (final StudentDashboardViewType view : StudentDashboardViewType.values()) {
	            ...
	            if (view == StudentDashboardViewType.SCORES) {
	 ...
	 public final class ValoMenuItemButton extends Button {
	        ...
	        private final StudentDashboardViewType view;

	        public ValoMenuItemButton(final StudentDashboardViewType view) {
	            this.view = view;
